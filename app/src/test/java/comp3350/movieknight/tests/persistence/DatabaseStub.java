...
public class DatabaseStub implements DataAccess {
    ...
    public void open(String dbName)
    {
        ...
        tickets.add(ticket);
        ticket = new Ticket(2, 2, 1, 1);
        tickets.add(ticket);
        ticket = new Ticket(3, 3, 1, 2);
        tickets.add(ticket);
        ticket = new Ticket(4, 1, 1, 3);
        tickets.add(ticket);
        ticket = new Ticket(5, 2, 2,4);
        tickets.add(ticket);
        ticket = new Ticket(6, 3, 2, 5);
        tickets.add(ticket);
        ticket = new Ticket(7, 1, 2, 6);
        tickets.add(ticket);
        ticket = new Ticket(8, 2, 2, 7);
        tickets.add(ticket);
        ticket = new Ticket(1, 3, 3, 8);
        tickets.add(ticket);
        ticket = new Ticket(2, 1, 3, 9);
        tickets.add(ticket);
        ticket = new Ticket(3, 2, 3, 10);
        tickets.add(ticket);
        ticket = new Ticket(4, 3, 4, 11);
        tickets.add(ticket);
        ticket = new Ticket(5, 1, 5, 12);
        tickets.add(ticket);
        ticket = new Ticket(6, 2, 6, 13);
        tickets.add(ticket);
        ticket = new Ticket(7, 3, 6, 14);
        tickets.add(ticket);
        ticket = new Ticket(8, 1, 7, 15);
        tickets.add(ticket);
        ticket = new Ticket(1, 2, 8, 16);
        tickets.add(ticket);
        ticket = new Ticket(2, 3, 9,17);
        tickets.add(ticket);
        ticket = new Ticket(3, 1, 10, 18);
        tickets.add(ticket);
        ticket = new Ticket(4, 2, 11, 19);
        tickets.add(ticket);
        ticket = new Ticket(5, 3, 12, 1);
        tickets.add(ticket);
        ticket = new Ticket(6, 1, 12, 4);
        tickets.add(ticket);
        ticket = new Ticket(7, 2, 12,8);
        tickets.add(ticket);
        ticket = new Ticket(8, 3, 12,5);
        tickets.add(ticket);
    }
